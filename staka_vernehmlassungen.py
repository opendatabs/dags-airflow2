"""
# staka_vernehmlassungen.py
This DAG helps populating the following datasets:

[100514](https://data.bs.ch/explore/dataset/100514)
[100515](https://data.bs.ch/explore/dataset/100515)
[100516](https://data.bs.ch/explore/dataset/100516)
"""
...
with DAG(
    ...
    upload = FailureTrackingDockerOperator(
        ...
        mounts=[
            ...
            Mount(
                source="/mnt/OGD-DataExch/PD-Staka-Vernehmlassungen",
