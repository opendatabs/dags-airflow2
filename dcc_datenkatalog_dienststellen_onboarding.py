"""
# dcc_datenkatalog_dienststellen_onboarding
This DAG helps populating the following datasets:

- [100537](https://data.bs.ch/explore/dataset/100537)
"""
...
# DAG configuration
DAG_ID = "dcc_datenkatalog_dienststellen_onboarding"
FAILURE_THRESHOLD = 1
    ...
    upload = FailureTrackingDockerOperator(
        ...
        private_environment={
            **COMMON_ENV_VARS,
            ...
            "SHAREPOINT_SITE_NAME_DCC": Variable.get(
                "SHAREPOINT_SITE_NAME_DCC"
            ),
