"""
# dcc_dataspot_connector_bvd_stg_p2stg
This DAG runs the Dataspot connector for BVD Stadtgärtnerei p2stg database.

- Connects to BVD Stadtgärtnerei p2stg database
