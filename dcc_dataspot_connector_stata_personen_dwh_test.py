"""
# dcc_dataspot_connector_stata_personen_dwh_test
This DAG runs the Dataspot connector for StatA personen_dwh test database.

- Connects to StatA personen_dwh test database
...
CONTAINER_NAME = "dcc_dataspot_connector_stata_personen_dwh_test"

# Configuration constants local
EXECUTABLE_CONNECTOR_JAR_FILE = "dataspot-connector-2026.2-rc1.jar"
SHARED_FOLDER_IN_DATA_EXCH = "StatA-Personen-DWH-Test"
SERVICE_FILE_NAME = "myservice.yaml"
SERVICE_NAME = "MyDatabaseService"

# Configuration constants on github
WORKDIR_FOLDER_IN_GITHUB = "stata-personen-dwh-test" # Also used for Docker image name
