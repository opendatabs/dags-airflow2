"""
# kantonslabor_coliminder.py
This DAG helps populating the following datasets:

[100530](https://data.bs.ch/explore/dataset/100530)
"""
...
# DAG configuration
DAG_ID = "kantonslabor_coliminder"
FAILURE_THRESHOLD = 1
...
with DAG(
    ...
    upload = FailureTrackingDockerOperator(
        ...
        private_environment={
            **COMMON_ENV_VARS,
            "API_COLIMINDER_BASE_URL": Variable.get("API_COLIMINDER_BASE_URL"),
            "API_COLIMINDER_REALM": Variable.get("API_COLIMINDER_REALM"),
            "API_COLIMINDER_CLIENT_ID": Variable.get("API_COLIMINDER_CLIENT_ID"),
            "API_COLIMINDER_CLIENT_SECRET": Variable.get("API_COLIMINDER_CLIENT_SECRET"),
        },
        ...
        mounts=[
            Mount(
                source=f"/mnt/OGD-DataExch/GD-Kantonslabor-Badewasserqualitaet",
                target="/code/data",
                type="bind",
            ),
            Mount(
